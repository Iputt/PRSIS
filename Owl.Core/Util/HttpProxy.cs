...
namespace Owl.Util
{
    ...
    public class HttpRealProxy : RealProxy
    {
        ...
        public HttpRealProxy(Type httpproxy, string urlformat, Func<string, TransferObject, string> paramformater, Func<ReturnArg, object> resultformatr)
            : base(httpproxy)
        {
            UrlFormat = urlformat;
        ...
        public override IMessage Invoke(IMessage msg)
        {
            ...
            var req = (HttpWebRequest)HttpWebRequest.Create(string.Format(UrlFormat, m_urlbind[methodname]));
            req.Method = "POST";
            ...
            if (returnarg.Exception != null && !returnarg.IsExpHandled)
                throw new Exception(returnarg.Exception.Message, returnarg.Exception);
